...
* bionoi_autoencoder: autoencoder that trained on Bionoi images in a supervised manner. The trained autoencoder can be used to produce latent space vectors of Bionoi images for machine learning applications.
